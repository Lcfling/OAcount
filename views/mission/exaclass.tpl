...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="/exaclass/add?pid={{.parentid}}" class="btn btn-success">+新增分类</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
            ...
            <div class="panel-body">
              <table class="table table-bordered table-striped table-condensed">
                ...
                <tr>
                  ...
                  <td><a href="/exaclass/manage?pid={{$v.Id}}">{{$v.Title}}</a> </td>
                  ...
                  <td><div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="/examination/manage/?pid={{$v.Id}}">查看内容</a></li>
                        <li role="separator" class="divider"></li>
