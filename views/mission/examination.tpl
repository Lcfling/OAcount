...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"><a href="/examination/add?pid={{.parentid}}" class="btn btn-success">+新内容</a></div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
              ...
              <section id="unseen">
                <form id="project-form-list">
                  <table class="table table-bordered table-striped table-condensed">
                    ...
                    {{range $k,$v := .exa}}
                    <tr>
                      <td><a href="">{{GetExaclassName $v.Pid}}</a></td>

                      <td style="text-align: left;text-indent:2em;">{{$v.Name}}</td>
