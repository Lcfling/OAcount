        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="arraignment-form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="" disabled="disabled" placeholder="请填写描述" style="height:300px;" class="form-control">{{.missionmy.Detail}}</textarea>
                  </div>
                </div>
                <div class="form-group">
                      ...
                      <div class="panel">
                        <div class="panel-body">
                          <ul class="p-info">
                            ...
                            <li>
                              <div class="desk"><a target="_blank" href="{{$v.Path}}">{{$v.Oldname}}</a></div>
                            </li>
                            {{end}}
                          </ul>
                        </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">审核状态</label>
                  <div class="col-sm-10">
                    <select name="arraignment" class="form-control">
