            ...
            <div class="panel-body">
              <form class="form-horizontal adminex-form" id="news-form">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="title" value="" class="form-control" placeholder="请填写名称">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">消息类型</label>
                  <div class="col-sm-10">
                    <select name="classid" class="form-control" id="types">
                      {{range $k,$v:=.classic}}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="content" placeholder="请填写描述" style="height:300px;" class="form-control"></textarea>
                  </div>
                </div>
