...
func (this *LoginUserController) Get() {
	check := this.IndexController.IsLogin
	if check {
		this.Redirect("/", 302)
		return
	} else {
...
func (this *LoginUserController) Post() {
	...
	if err == nil {
		...
		this.Data["json"] = map[string]interface{}{"code": 1, "message": "贺喜你，登录成功", "data": map[string]interface{}{"url": "/"}}
	} else {
...
func (this *RegisterController) Post() {
	...
	if password != repassword {
		this.Data["json"] = map[string]interface{}{"code": 0, "message": "两次密码不同！"}
		this.ServeJSON()
	}
